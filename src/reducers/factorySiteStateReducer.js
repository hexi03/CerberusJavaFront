import {FACTORYSITESTATE, FETCHNOTFOUND, FETCHONE} from "../actions/actions.js";

const initialState = {
  states: {}
};
//ALARM switch inheritance
export const factorySiteStateReducer = (state = initialState, action) => {
  if (action.scope === FACTORYSITESTATE) {
    console.log(action);
