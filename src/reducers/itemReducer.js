import {CREATE, DELETE, FETCHALL, FETCHNOTFOUND, FETCHONE, ITEM, UPDATE} from "../actions/actions.js";
...
export const itemReducer = (state = initialState, action) => {
  if (action.scope === ITEM) {
    ...
    switch (action.action) {
      case FETCHALL:
        state = {...state, items: action.items.reduce((dictionary,index) => {dictionary[index.id] = index; return dictionary} , {}) };
        break;
      case FETCHONE:
      case UPDATE:
